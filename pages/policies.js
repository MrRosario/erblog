...
const Policies = () => {
    return(
        <>
            ...
            />
            <div className="main">
                <article className="content policies">
                    <h2>Política de privacidade para <strong>eugeniorosario.com</strong></h2>
                    ...
                    <p>A garantia da confidencialidade dos dados pessoais dos usuários desse site é importante para o <strong>eugeniorosario.com</strong>.</p>
                    <p>Todas as informações pessoais que usem o <strong>eugeniorosario.com</strong> serão tratadas em concordância com a Lei Nº 13.709, de 14 de Agosto de 2018.</p>
                    ...
                    <p>O <strong>eugeniorosario.com</strong> possui conexões para outros sites, que podem conter informações úteis. A nossa política de privacidade não é aplicada a sites de terceiros, pelo que, caso visite outro site a partir do nosso deverá ler a politica de privacidade do mesmo.</p>
